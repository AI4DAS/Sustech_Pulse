...
answer = pd.read_csv("/home/disk/wd_black/wzm/Sustech_Pulse/tutorial/08-an/T3.an",sep='\s+' ,names=['filename','class'])
score=0
y=[]

for i in range(205):
   file_name  = answer.iloc[i,0]
   st = obspy.read('/home/disk/wd_black/wzm/Sustech_Pulse/tutorial/08-exam/T3/'+file_name)
